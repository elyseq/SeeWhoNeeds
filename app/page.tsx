    ...
    <main className="min-h-screen flex flex-col">
      <nav className="w-full border-b h-16 flex items-center px-6 justify-between">
        ...
        <div className="flex gap-3 items-center">
          <Link href="/needs"><Button variant="ghost">Browse Needs</Button></Link>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 gap-6 py-24">
        ...
        <div className="flex gap-4 mt-4">
          <Link href="/needs"><Button size="lg">See who needs what</Button></Link>
          <Link href="/auth/sign-up"><Button size="lg" variant="outline">I have things to give</Button></Link>
        </div>
      </div>
